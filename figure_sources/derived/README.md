...
- Figure 1 removes the embedded slide title and unused whitespace.
- Figure 2 removes unused top and bottom whitespace while retaining panels A-D.
- Figure 4 removes the Neuronal traces column and retains cohorts, rigs, mouse platforms, and brain-targeting schematics.
