...
spike times and nearest displayed peak channels; selecting a marker or unit
highlights its depth and waveform-spread band and shows a 12 s binned-rate trace
plus its peak-channel mean template. The **Mesoscope** tab provides all eight
...
segmentation over a grayscale mean image; image axes are transposed into display
coordinates before applying the masks, and selection reveals a 30 s,
approximately 200 Hz ΔF/F trace. Microscopy background controls alter only
