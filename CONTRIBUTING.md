...
- `scripts/extract_neuropixels_event_responses.py` streams four versioned Neuropixels NWBs from one mouse, computes context and matched-control unit PSTHs plus baseline and response summaries, and writes committed metadata and compressed count/waveform atlases for the interactive unit-response explorer.
